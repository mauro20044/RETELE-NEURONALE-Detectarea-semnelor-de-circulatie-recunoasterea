...
### Status implementat (2026-01-15)

- Aplicația Flask (app.py) și CLI-ul predict preferă acum `models/optimized_model.h5` dacă există; fallback pe `models/trained_model.h5`. Modelul optimizat nu este încă generat în acest repository.
